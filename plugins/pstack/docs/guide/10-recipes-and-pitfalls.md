...
![She tastes a finished dish while robots cook from a recipe box, with pinned cards reading $pstack:how, $pstack:tdd, and a wake heartbeat above the counter.](./images/recipes.jpg)
...
```text
ask $pstack:arena for a second opinion on this task and our approach
```
...
- **A vague finish condition.** "make it better" gives the wake loop nothing to check. Give a command or artifact that can pass or fail.
