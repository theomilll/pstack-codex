...
![She tastes a finished dish while robots cook from a recipe box, with pinned cards reading $how, $tdd, and a wake heartbeat above the counter.](./images/recipes.jpg)
...
```text
ask $arena for a second opinion on this task and our approach
```
