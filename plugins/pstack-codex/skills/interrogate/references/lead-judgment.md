...
- Multiple reviewers flag the same issue independently (a lead to verify, not proof by agreement)
...
Be especially careful about dismissing security findings and correctness bugs. These deserve more scrutiny even when only one reviewer reports them.
