...
3. Explore in subagents with the poteto-mode prompt contract and an available model per `../references/codex-delegation.md` (the **guard-the-context-window** principle skill). Each returns file pointers, conventions, test commands, and entry points. No inlined dumps.
