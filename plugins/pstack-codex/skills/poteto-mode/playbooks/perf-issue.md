...
1. Capture a baseline trace via the project's verification skill.
...
3. Plan the fix from the trace. If it crosses a function boundary, `architect` first. Delegate implementation to a `gpt-5.6-sol` subagent; review the diff. Capture a post-fix trace.
