...
# state, uncommitted work, and remote/PR state. It deliberately does not scan
# Codex transcripts because sessions are not partitioned by repository. Emits
# a table sorted by size with a suggested bucket. Never deletes anything;
